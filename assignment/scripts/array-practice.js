...
let favoriteFoods = [ 'cannoli', 'italian ice', 'sfogliatella', 'rainbow cookie'];
...
console.log('Number of favorite Italian desserts:', favoriteFoods.length);
...
// 3.a. TODO: Log the second food in the array 
console.log('Second dessert is:', favoriteFoods [1]);

// 3.b. TODO: Log the last food in the array using it's array index 
console.log('Last dessert is:', 'rainbow cookie');
...
// onsole.log('The animals are now', animalArray);
