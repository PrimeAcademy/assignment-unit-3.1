...
let favoriteFoods = ['Ribeye', 'Eggs', 'Chicken'];
...
favoriteFoods.unshift('hamburger');
...
console.log(removedFood, favoriteFoods);

// 4.e (STRETCH) TODO: Replace the second food in your array
//      with another one of your favorite foods.
//      Then log the updated array.
favoriteFoods[1] = 'wings';
console.log(favoriteFoods);

// 4.f (STRETCH) TODO: Sort your favoriteFoods array
//     in reverse alphabetical order. Log the array.
let alphabeticalFavoriteFoods = favoriteFoods.sort().reverse();
console.log(alphabeticalFavoriteFoods);
// Or with same array
...
let favoriteFoodsString = favoriteFoods.toString().replaceAll(',', ' and ');
...
let newArr = [...favoriteFoods, ...animalArray];
console.log(newArr);