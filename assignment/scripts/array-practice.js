...
let favoriteFoods = ['carbonara', 'biscotti', 'mint ice cream']
...
console.log('Last animal is', animalArray.length - 4);
...
favoriteFoods.unshift('cinnamon rolls');
